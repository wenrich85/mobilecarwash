...
for attrs <- [
      %{
        ...
        icon: "sparkles",
        sort_order: 1,
        description: "Hand wax for a deep, protective shine."
      },
      %{
        name: "Interior Shampoo",
        slug: "interior_shampoo",
        price_cents: 2_500,
        icon: "sparkles",
        sort_order: 2,
      ...
      %{
        ...
        slug: "engine_bay_clean",
        price_cents: 2_000,
        icon: "sparkles",
        sort_order: 4,
        description: "Degrease and detail the engine bay."
      },
      %{
        ...
        icon: "sparkles",
        sort_order: 5,
        description: "Restore clouded headlights to clear."
      }
    ] do
...
categories =
  for attrs <- [
        %{
          name: "Texas State Formation",
          slug: "tx_state",
          sort_order: 1,
          description: "State-level business formation requirements for Texas"
        },
        %{
          name: "Federal Requirements",
          slug: "federal",
          sort_order: 2,
          description: "Federal tax, banking, and insurance requirements"
        },
        %{
          name: "Disabled Veteran Certifications",
          slug: "veteran_certs",
          sort_order: 3,
          description: "VA and SBA certifications for 100% disabled veteran-owned business"
        },
        %{
          name: "Compliance & Renewals",
          slug: "compliance_renewals",
          sort_order: 4,
          description: "Recurring filings, renewals, and ongoing compliance"
        }
      ] do
    existing =
      TaskCategory
...
formation_tasks = [
  ...
  %{
    name: "LLC Filing with TX Secretary of State",
    category_slug: "tx_state",
    priority: :high,
    description:
      "File Certificate of Formation (Form 205) with the Texas Secretary of State. Filing fee ~$300.",
  ...
  %{
    ...
    priority: :high,
    description:
      "Designate a registered agent in Texas to receive legal documents on behalf of the LLC."
  },
  %{
    ...
    priority: :high,
    description:
      "Apply for a Texas Sales and Use Tax Permit from the Comptroller. Required before collecting sales tax.",
    external_url: "https://comptroller.texas.gov/taxes/permit/"
  },
  %{
    name: "TX Franchise Tax Registration",
    category_slug: "tx_state",
    priority: :high,
    description:
      "Register for Texas franchise tax. All LLCs must file an annual franchise tax report."
  },
  %{
    name: "Business License / DBA Filing",
    category_slug: "tx_state",
    priority: :medium,
    description:
      "File assumed name certificate (DBA) with the county clerk if operating under a trade name."
  },
  %{
    ...
    priority: :low,
    description:
      "Texas does not require workers comp for most employers, but consider it when hiring employees."
  },

  # Federal Requirements
  %{
    name: "EIN from IRS",
    category_slug: "federal",
    priority: :high,
    description:
      "Apply for an Employer Identification Number online. Required for tax filing, banking, and hiring.",
    external_url:
      "https://www.irs.gov/businesses/small-businesses-self-employed/apply-for-an-employer-identification-number-ein-online"
  },
  %{
    name: "Federal Tax Obligations Setup",
    category_slug: "federal",
    priority: :high,
    description:
      "Determine federal tax obligations: self-employment tax, estimated quarterly taxes, income tax."
  },
  %{
    ...
    priority: :high,
    description:
      "Open a dedicated business checking account. Keep personal and business finances separate."
  },
  %{
    ...
    priority: :high,
    description:
      "Obtain general liability insurance to protect against property damage and injury claims."
  },
  %{
    ...
    priority: :high,
    description:
      "Insure the service van with commercial auto insurance. Personal auto policies don't cover business use."
  },

  # Disabled Veteran Certifications
  %{
    name: "VA Disability Rating Verification (100%)",
    category_slug: "veteran_certs",
    priority: :high,
    description:
      "Obtain and keep current your VA disability rating letter showing 100% service-connected disability."
  },
  %{
    name: "SBA VOSB Certification",
    category_slug: "veteran_certs",
    priority: :high,
    description:
      "Apply for Veteran-Owned Small Business (VOSB) certification through SBA's VetCert program.",
    external_url: "https://veteransbusiness.sba.gov/"
  },
  %{
    name: "SBA SDVOSB Certification",
    category_slug: "veteran_certs",
    priority: :high,
    description:
      "Apply for Service-Disabled Veteran-Owned Small Business (SDVOSB) certification. Opens federal contracting opportunities.",
    external_url: "https://veteransbusiness.sba.gov/"
  },
  %{
    name: "TX HUB Certification",
    category_slug: "veteran_certs",
    priority: :high,
    description:
      "Apply for Historically Underutilized Business (HUB) certification with the TX Comptroller. Qualifies for state contracting preferences.",
    external_url: "https://comptroller.texas.gov/purchasing/vendor/hub/"
  },
  %{
    name: "Property Tax Exemption - TX Disabled Veteran",
    category_slug: "veteran_certs",
    priority: :medium,
    description:
      "Apply for property tax exemption available to 100% disabled veterans in Texas. File with county appraisal district."
  },
  %{
    name: "TX Franchise Tax Exemption (Disabled Veteran)",
    category_slug: "veteran_certs",
    priority: :medium,
    description:
      "100% disabled veterans may qualify for a total franchise tax exemption in Texas. File exemption request with Comptroller."
  },

  # Compliance & Renewals
  %{
    name: "Annual TX Franchise Tax Report",
    category_slug: "compliance_renewals",
    priority: :high,
    recurring: true,
    recurrence_months: 12,
    due_date: ~D[2027-05-15],
    description:
      "File annual franchise tax report by May 15. Even exempt businesses must file a No Tax Due report."
  },
  %{
  ...
  %{
    name: "Business Insurance Renewal",
    category_slug: "compliance_renewals",
    priority: :high,
    recurring: true,
    recurrence_months: 12,
    description:
      "Renew general liability and commercial auto insurance policies before expiration."
  },
  %{
    ...
    recurring: true,
    recurrence_months: 3,
    due_date: ~D[2026-07-20],
    description:
      "File quarterly sales tax report with TX Comptroller. Due 20th of month following quarter end."
  },
  %{
    name: "Environmental Compliance - Water Disposal",
    category_slug: "compliance_renewals",
    priority: :medium,
    description:
      "Ensure compliance with TX water disposal regulations for mobile car wash operations. Collect and properly dispose of wash water."
  }
]
...
positions_data = [
  %{
    ...
    sort_order: 1,
    description:
      "Strategic leadership, business development, financial oversight. Sets the vision and ensures all systems are working."
  },
  %{
    ...
    sort_order: 2,
    description:
      "Manages day-to-day operations, scheduling, quality control, and technician training."
  },
  %{
    ...
    sort_order: 3,
    description:
      "Senior wash technician. Trains new hires, handles complex details, ensures quality standards."
  },
  %{
    name: "Technician",
    slug: "technician",
    ...
    sort_order: 4,
    description:
      "Performs car wash services following SOPs. Uses checklists for every appointment."
  },
  %{
...
for {slug, parent_slug} <- [
      {"ops_manager", "owner"},
      {"lead_tech", "ops_manager"},
      {"technician", "ops_manager"},
...
basic_wash_st =
  ServiceType |> Ash.Query.filter(slug == "basic_wash") |> Ash.read!() |> List.first()

deep_clean_st =
  ServiceType |> Ash.Query.filter(slug == "deep_clean") |> Ash.read!() |> List.first()
...
procedures_data = [
  %{
    ...
    slug: "basic_wash_sop",
    description:
      "Standard operating procedure for a basic exterior wash. Every step must be completed and checked off.",
    category: :wash,
    ...
    steps: [
      %{
        ...
        description:
          "Walk around vehicle. Note any existing damage, scratches, or dents. Take photos if needed. Alert customer of any pre-existing issues.",
        estimated_minutes: 3
      },
      %{
        step_number: 2,
        title: "Pre-Rinse",
        description:
          "Rinse entire vehicle with deionized water to remove loose dirt and debris. Start from top, work down.",
        estimated_minutes: 5
      },
      %{
        step_number: 3,
        title: "Apply Soap",
        description:
          "Apply car wash soap using foam cannon. Ensure full coverage on all panels, bumpers, and trim.",
        estimated_minutes: 3
      },
      %{
        step_number: 4,
        title: "Hand Wash / Scrub",
        description:
          "Using microfiber wash mitt, wash all panels in straight lines (not circles). Two-bucket method. Rinse mitt frequently.",
      ...
      %{
        ...
        title: "Rinse",
        description:
          "Thoroughly rinse all soap from vehicle with deionized water. Check for missed spots.",
        estimated_minutes: 5
      },
      %{
        step_number: 6,
        ...
        description:
          "Clean wheels with wheel cleaner and brush. Clean tire sidewalls. Apply tire dressing.",
        estimated_minutes: 5
      },
      %{
        step_number: 7,
        title: "Dry",
        description:
          "Dry vehicle using clean microfiber drying towels. Use air blower for crevices and mirrors.",
        estimated_minutes: 8
      },
      %{
        step_number: 8,
        ...
        description:
          "Walk around vehicle for quality check. Ensure no water spots, streaks, or missed areas. Clean windows if needed.",
        estimated_minutes: 3
      }
    ]
  },
  %{
    ...
    slug: "deep_clean_sop",
    description:
      "Full interior and exterior detail procedure. Premium service with clay bar, wax, and full interior treatment.",
    category: :wash,
    ...
    steps: [
      %{
        ...
        title: "Vehicle Inspection",
        description:
          "Comprehensive inspection inside and out. Document all existing damage. Photograph interior condition.",
        estimated_minutes: 5
      },
      %{
        step_number: 2,
        title: "Interior - Remove Trash & Personal Items",
        description: "Remove all trash. Set aside personal items carefully. Remove floor mats.",
        estimated_minutes: 5
      },
      %{
        step_number: 3,
        ...
        description:
          "Vacuum all seats, carpets, floor mats, trunk, and crevices. Use detail brush for tight areas.",
        estimated_minutes: 15
      },
      %{
        step_number: 4,
        title: "Interior - Dashboard & Console",
        description:
          "Clean and condition dashboard, center console, door panels, and all plastic/vinyl surfaces.",
        estimated_minutes: 10
      },
      %{
        step_number: 5,
        ...
        description:
          "Clean and condition leather seats (or shampoo fabric seats). Treat all seating surfaces.",
        estimated_minutes: 10
      },
      %{
        step_number: 6,
        title: "Interior - Carpet Shampoo",
        description: "Shampoo carpets and floor mats. Extract moisture. Allow to dry.",
        estimated_minutes: 10
      },
      %{
        step_number: 7,
        title: "Interior - Windows & Mirrors",
        description: "Clean all interior glass surfaces streak-free.",
        estimated_minutes: 5
      },
      %{
        step_number: 8,
        title: "Exterior - Pre-Rinse",
        description: "Rinse entire exterior with deionized water.",
        estimated_minutes: 5
      },
      %{
        step_number: 9,
        title: "Exterior - Foam & Hand Wash",
        description: "Foam cannon + two-bucket hand wash on all exterior panels.",
        estimated_minutes: 12
      },
      %{
        step_number: 10,
        title: "Exterior - Clay Bar Treatment",
        description:
          "Clay bar entire painted surface to remove bonded contaminants. Leaves paint glass-smooth.",
        estimated_minutes: 15
      },
      %{
        step_number: 11,
        title: "Exterior - Rinse & Dry",
        description: "Final rinse with deionized water. Hand dry with microfiber towels.",
        estimated_minutes: 8
      },
      %{
        step_number: 12,
        title: "Exterior - Wax / Sealant",
        description:
          "Apply carnauba wax or paint sealant to all painted surfaces. Buff to shine.",
        estimated_minutes: 15
      },
      %{
        step_number: 13,
        title: "Tires & Wheels",
        description: "Deep clean wheels, apply tire dressing.",
        estimated_minutes: 5
      },
      %{
        step_number: 14,
        title: "Engine Bay",
        description:
          "Carefully degrease and clean engine bay. Cover sensitive electronics. Rinse and dress.",
        estimated_minutes: 10,
        required: false
      },
      %{
        ...
        title: "Final Inspection",
        description:
          "Complete walk-around inside and out. Check every surface. Ensure customer satisfaction standards met.",
        estimated_minutes: 5
      }
    ]
  }
...
for proc_data <- procedures_data do
  ...
  case existing do
    [] ->
      # Create procedure
      changeset =
        Procedure |> Ash.Changeset.for_create(:create, Map.drop(proc_attrs, [:service_type_id]))

      changeset =
        if proc_attrs[:service_type_id] do
          Ash.Changeset.force_change_attribute(
            changeset,
            :service_type_id,
            proc_attrs.service_type_id
          )
        else
          changeset
        end
...
customer_vehicle_address =
  ...
  |> Enum.map(fn {{customer, veh_attrs}, addr_attrs} ->
    ...
    existing_veh =
      Vehicle
      |> Ash.Query.filter(
        customer_id == ^customer.id and make == ^veh_attrs.make and model == ^veh_attrs.model
      )
    ...
    vehicle =
      case existing_veh do
        [] ->
          ...
          IO.puts(
            "  ✓ Vehicle: #{veh_attrs.year} #{veh_attrs.make} #{veh_attrs.model} → #{customer.name}"
          )
...
|> Enum.each(fn {{day_offset, status}, idx} ->
  {customer, vehicle, address} =
    Enum.at(customer_vehicle_address, rem(idx, length(customer_vehicle_address)))

  service_type = Enum.at(service_types, rem(idx, length(service_types)))

  technician =
    if status in [:confirmed, :in_progress, :completed],
      do: Enum.at(all_techs, rem(idx, length(all_techs))),
      else: nil

  hour = Enum.at([8, 9, 10, 11, 13, 14, 15, 16], rem(idx, 8))

  scheduled_at =
    DateTime.add(base, day_offset * 86400 + (hour - 12) * 3600, :second)
    ...
    [] ->
      base_changeset =
        ...
        |> Ash.Changeset.for_create(:create, %{
          ...
          notes:
            Enum.at(
              ["Sensitive paint", "Dog hair inside", "Please rinse wheels twice", nil, nil],
              rem(idx, 5)
            )
        })
        |> Ash.Changeset.force_change_attribute(:customer_id, customer.id)
      ...
      IO.puts(
        "  ✓ #{service_type.name} | #{customer.name} | #{Date.to_string(DateTime.to_date(scheduled_at))} #{status}#{tech_label}"
      )
  end
end)
