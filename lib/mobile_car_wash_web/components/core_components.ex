defmodule MobileCarWashWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MobileCarWashWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MobileCarWashWeb.Gettext, "errors", msg, opts)
    end
  end
