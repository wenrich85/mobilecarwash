defmodule MobileCarWashWeb.BookingComponentsTest do
  ...
  describe "booking_summary/1" do
    test "renders all booking detail fields" do
      ...
      html = rendered_to_string(~H|<.booking_summary
...
/>|)
  ...
  describe "saved_record_card/1" do
    test "renders title and subtitle" do
      ...
      html =
        rendered_to_string(
          ~H|<.saved_record_card title="2023 Tesla Model 3" subtitle="Silver · car" />|
        )
    ...
    test "passes through phx-click and phx-value-id to root element" do
      ...
      html =
        rendered_to_string(
          ~H|<.saved_record_card title="X" phx-click="select_vehicle" phx-value-id="abc-123" />|
        )
