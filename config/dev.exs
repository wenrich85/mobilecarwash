...
config :mobile_car_wash, MobileCarWashWeb.Endpoint,
  ...
  secret_key_base:
    System.get_env(
      "SECRET_KEY_BASE",
      "dev-only-key-not-for-production-use-at-all-must-be-64-chars-minimum"
    ),
  watchers: [
...
config :mobile_car_wash, MobileCarWashWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/mobile_car_wash_web/router\.ex$",
      ~r"lib/mobile_car_wash_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
...
config :mobile_car_wash,
       ...
       System.get_env("TOKEN_SIGNING_SECRET") ||
         "dev-only-secret-change-in-production-at-least-64-chars"
